...
type SafeboxTask struct {
	...
	FundingTxid      string    `gorm:"not null;index:unique_funding_txid_out_index,unique" json:"funding_txid"`
	FundingOutIndex  uint64    `gorm:"not null;index:unique_funding_txid_out_index,unique" json:"funding_out_index"`
	TimelockTxid     string    `gorm:"not null;index:unique_timelock_txid_out_index,unique" json:"timelock_txid"`
	TimelockOutIndex uint64    `gorm:"not null;index:unique_timelock_txid_out_index,unique" json:"timelock_out_index"`
