...
type SafeboxTask struct {
	...
	DepositAddress   string    `gorm:"not null;uniqueIndex:unique_deposit_address_idx,unique" json:"deposit_address"`
	...
	TimelockAddress  string    `gorm:"not null;uniqueIndex:unique_timelock_address_idx,unique" json:"timelock_address"`
